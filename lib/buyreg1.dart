import 'package:agroexpress/buyreg2.dart';
import 'package:agroexpress/usertype.dart';
import 'package:flutter/material.dart';

class BuyRegOne extends StatefulWidget {
  @override
  _BuyRegOneState createState() => _BuyRegOneState();
}

class _BuyRegOneState extends State<BuyRegOne> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/buyreg1.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Form(
              ...
              Row(
                children: <Widget> [
                  ...
                  Container(
                    ...
                    child: FlatButton(
                      onPressed: ()  => Navigator.push(context, new MaterialPageRoute(builder: (_) => BuyRegTwo())),
                      child: Text(
                        "Next",
                        style: TextStyle(
                          color: Colors.white,
