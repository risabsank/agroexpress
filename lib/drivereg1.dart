...
class DriveRegOne extends StatefulWidget {
  @override
  _DriveRegOneState createState() => _DriveRegOneState();
}

class _DriveRegOneState extends State<DriveRegOne> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/drivereg1.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Form(
