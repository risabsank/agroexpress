...
import 'package:agroexpress/drivereg3.dart';
import 'package:flutter/material.dart';

class DriveRegTwo extends StatefulWidget {
  @override
  _DriveRegTwoState createState() => _DriveRegTwoState();
}

class _DriveRegTwoState extends State<DriveRegTwo> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/drivereg2.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Form(
              ...
              Row(
                children: <Widget> [
                  ...
                  Container(
                    ...
                    child: FlatButton(
                      onPressed: ()  => Navigator.push(context, new MaterialPageRoute(builder: (_) => DriveRegThree())),
                      child: Text(
                        "Next",
                        style: TextStyle(
                          color: Colors.white,
